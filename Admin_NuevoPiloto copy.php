...
<body class="dark_theme  fixed_header left_nav_fixed light_theme green_thm">
            ...
            <div class="contentpanel">
                ...
                <!-- Iicia Contenido -->
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <button class="btn btn-outline-danger my-2 my-sm-0" type="button" onclick="RegresarPiltos()">Regresar</button>
    ...
    <script>
    function RegresarPiltos()
{
     location.href = "http://localhost/Projects/MoleTracker/Admin_Pilotos.php";
} 
    </script> 
