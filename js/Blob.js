...
(function (e, t) {
    ...
    var i = e.BlobBuilder || e.WebKitBlobBuilder || e.MozBlobBuilder || function (e) {
        var t = function (e) {
                ...
                this.type = n;
                this.encoding = i
            }, o = n.prototype, r = i.prototype, a = e.FileReaderSync, f = function (e) {
            ...
            s = c.length, l = e.URL || e.webkitURL || e, u = l.createObjectURL, d = l.revokeObjectURL, p = l,
            b = e.btoa, h = e.atob, R = e.ArrayBuffer, g = e.Uint8Array, w = /^[\w-]+:\/*\[?[\w\.:-]+\]?(?::[0-9]+)?/;
        i.fake = r.fake = true;
        while (s--) {
            f.prototype[c[s]] = s + 1
        }
        ...
        o.append = function (e) {
            ...
            if (g && (e instanceof R || e instanceof g)) {
                var o = "", r = new g(e), c = 0, s = r.length;
                for (; c < s; c++) {
