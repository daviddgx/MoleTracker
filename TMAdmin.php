    ...
    //echo $FNameF."<br>".$FNameL."<br>".$FUserName."<br>".$FEmail."<br>".$FEmailR."<br>".$FPassword."<br>".$FPasswordR ;
            ...
            if($Presidente == ""){
                ...
                // echo 'Usuario Vacio' ;
                     ...
                     $sql ="INSERT INTO `db706267167`.`voto` (`Precidente`, `Alcalde`, `Diputado`) VALUES ('".$Presidente."','".$Alcalde."','".$Diputado."')";
                    ...
                    <ul>
                        <li class="left_nav_active theme_border"><a href="javascript:void(0);"><i class="fa fa-home"></i> DASHBOARD <span class="left_nav_pointer"></span> <span class="plus"><i class="fa fa-plus"></i></span> </a>
                            <ul class="opened" style="display:block">
                                ...
                                <li>
                                    <a href="votacionesAdmin.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b  class="theme_color">Emitir Votos</b> </a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                                            ...
                                            <!-- Finaliza el div del contenido general -->
                                                    ...
                                                    <?php
                                                     //Crear un cilco que imprima a cada presidente, su foro e informacion   
                                                        ...
                                                        $conn = new mysqli($servername,$username,$password,$dbname);
                                                        $municipios = "SELECT Nombre, Apellido, Partido FROM db706267167.candidatos where Cargo='presidente';"; 
                                        ...
                                        <div class="saltito"><h1></h1></div>  
                                            ...
                                            <?php
                                                     //Crear un cilco que imprima a cada presidente, su foro e informacion   
                                                        ...
                                                        $conn = new mysqli($servername,$username,$password,$dbname);
                                                        $municipios = "SELECT Nombre, Apellido, Partido FROM db706267167.candidatos where Cargo='Alcalde';"; 
                                    ...
                                    <div class="saltito"><h1></h1></div>
                                            ...
                                            <?php
                                                     //Crear un cilco que imprima a cada presidente, su foro e informacion   
                                                        ...
                                                        $conn = new mysqli($servername,$username,$password,$dbname);
                                                        $municipios = "SELECT Nombre, Apellido, Partido FROM db706267167.candidatos where Cargo='diputado';"; 
