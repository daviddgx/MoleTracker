...
<body class="dark_theme  fixed_header left_nav_fixed light_theme green_thm">
                    ...
                    <!-- Fin NavBar Mantenimiento -->          
                            ...
                            <div class="myform-all Color_Claro">
                                ...
                                <div class="my-content formulario">
                                    ...
                                    <h1 ><strong>Detalle de </strong> Guia</h1>   
  ...
  <br>
  <div class="row">
    <div class="col-6 myform-all" id="centrador">
    <img src="imagenes/MapaGuia.PNG" id="imagen" alt="Italian Trulli" class="img-responsive">
    </div>
    <div class="col-6 myform-all" id="centrador">
    <img src="imagenes/CemaforoVerde.png" id="imagen2" alt="Italian Trulli" class="img-responsive">
    </div>
