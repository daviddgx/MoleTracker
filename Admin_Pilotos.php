...
include 'Auth.php';
include 'LQS_EUQ/UsuariosRegistrados.php';
                    ...
                    <ul>
                        <li class="left_nav_active theme_border"><a href="javascript:void(0);"><i class="fa fa-home"></i> ADMINISTRACION <span class="left_nav_pointer"></span> <span class="plus"><i class="fa fa-plus"></i></span> </a>
                            <ul class="opened" style="display:block">
                                ...
                                <li>
                                    <a href="Admin_Pilotos.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">Pilotos</b> </a>
                                </li>
                                <li>
            ...
            <div class="contentpanel">
                ...
                <!-- Iicia Contenido -->
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <button class="btn btn-outline-success my-2 my-sm-0" type="button" onclick="CrearPiloto()">Registrar Nuevo Piloto</button>
                        ...
                        <table>
                                    <tr>
                                        ...
                                        for ($i = 0; $i < $lista_Usuarios; $i++) {
                                            ...
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_Usuarios['Activo'];
                                            echo "</td>";
                                            
                                            echo "<td>";
                                                    echo '<a href="'.$lista_Usuarios['RFID'].'"  class="fa fa-pencil btn btn-info data-togle="modal" data-target="#myModal"></a>';
                                            echo "</td>";

                                            echo "</tr>";       
                                            $lista_Usuarios = $ejecutar_sentencia->fetch_array();
                                        }
                                        ?>
                                    </tr>
