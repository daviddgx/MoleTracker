<?php
    include 'Auth.php';
    include 'LQS_EUQ/PartidosPoliticos.php';


    if (!empty($_POST['Registrar'])) {
        sleep(2);
        $FName = $_POST['form-nombre'];
        $FDescripcion = $_POST['form-descripcion'];
        $FReprecentante = $_POST['form-reprecentante'];
        ...
        //echo $FNameF."<br>".$FNameL."<br>".$FUserName."<br>".$FEmail."<br>".$FEmailR."<br>".$FPassword."<br>".$FPasswordR ;
                ...
                if($FName == ""){
                    ...
                    // echo 'Clave Vacio' ;
                         ...
                         $sql ="INSERT INTO `db706267167`.`inscri_partido` (`Nombre_Partido`, `RFID`, `Reprecentante`, `Descripcion`) VALUES ('".$FName."','".$FRFID."','".$FReprecentante."','".$FDescripcion."')";
                    ...
                    <ul>
                        <li class="left_nav_active theme_border"><a href="javascript:void(0);"><i class="fa fa-home"></i> DASHBOARD <span class="left_nav_pointer"></span> <span class="plus"><i class="fa fa-plus"></i></span> </a>
                            <ul class="opened" style="display:block">
                                ...
                                <li>
                                    <a href="Partidos.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">Partidos</b> </a>
                                </li>
                                <li>
            ...
            <div class="contentpanel">
                ...
                <div class="pull-left breadcrumb_admin clear_both">
                    <div class="pull-left page_title theme_color">
                        <h1>Administracion de Partidos</h1>
                        <h2 class="">Registro de Partidos...</h2>
                    </div>
              ...
              <div class="row">
                <div id="listausuarios" class="col-md-6" >
                        ...
                        <br></br>
                        <h1 class="Titulos">Partidos Registrados</h1>
                        <table>
                                    <tr>
                                        <th>Numero</th>
                                        <th>Partido</th>
                                        ...
                                        <?php
                                            for($i=0; $i<$lista_usuario; $i++){
                                                echo "<tr>";
                                                    ...
                                                    echo "<td>";
                                                        echo $lista_usuario['Nombre_Partido'];
                                                    echo "</td>";
                                                    ...
                                                    echo "<td>";
                                                        echo $lista_usuario['Reprecentante'];
                                                    echo "</td>";
                                        ...
                                        <div class="  myform-cont" >
                                            <div class="myform-top">
                                                <div class="myform-top-left">
                                                    <h3 class="whitecolor">Registro de Partidos</h3>
                                                    <p class="whitecolor">Digite los datos del partido:</p>
                                                </div>
                                                <div class="myform-top-rigth">
                                                <i class="fa fa-flag users whitecolor"> </i>
                                            ...
                                            <div class="myform-botton">
                                                <form role="form" action="" method="post" class="">
                                                    ...
                                                    <div class="form-grup">
                                                        <input type="text" name="form-descripcion" placeholder="Descripcion..." class="form-control" id="form-descripcion">
                                                    </div>
                                                    <div class="saltito"><h1></h1></div>
                                                    <div class="form-grup">
                                                        <input type="text" name="form-reprecentante" placeholder="Reprecentante..." class="form-control" id="form-reprecentante">
                                                    </div>
                                                    <div class="saltito"><h1></h1></div>
                                                    <div class="form-grup">
