...
include 'Auth.php';
include 'LQS_EUQ/GuiasTrakerAll.php';
            ...
            <div class="contentpanel">
                ...
                <!-- Iicia Contenido -->
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <button class="btn btn-outline-info my-2 my-sm-0" type="button" onclick="CargarGuias()">Visualizar Guias En proceso y terminadas</button>
                        </form>
                    </div>
                    </nav>
                    <br>
                        ...
                        <table>
                                    <tr>
                                        ...
                                        for ($i = 0; $i < $lista_Guias; $i++) {
                                            ...
                                            echo "<td>";
                                                    echo '<a href="'.$lista_Guias['ID_GUIA'].'"  class="fa fa-dashboard btn btn-primary data-togle="modal" data-target="#myModal"></a>';
                                            echo "</td>";
