...
<body class="dark_theme  fixed_header left_nav_fixed light_theme green_thm">
                    ...
                    <ul>
                        <li class="left_nav_active theme_border"><a href="javascript:void(0);"><i class="fa fa-home"></i> ADMINISTRACION <span class="left_nav_pointer"></span> <span class="plus"><i class="fa fa-plus"></i></span> </a>
                            <ul class="opened" style="display:block">
                                ...
                                <li>
                                    <a href="Admin_Unidades.php"> <span>&nbsp;</span> <i class="fa fa-circle  theme_color"></i> <b class="theme_color"> Unidades</b> </a>
                                </li>
                                <li>
            ...
            <div class="contentpanel">
                ...
                <!-- Iicia Contenido -->
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <button class="btn btn-outline-success my-2 my-sm-0" type="button" onclick="CargarNuevaUnidad()">Nueva Unidad</button>
    ...
    function CargarNuevaUnidad(){
     location.href = "http://localhost/Projects/MoleTracker/Admin_NuevaUnidad.php";
    }
    </script>
