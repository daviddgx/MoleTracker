                    ...
                    <ul>
                        <li class="left_nav_active theme_border"><a href="javascript:void(0);"><i class="fa fa-home"></i> DASHBOARD <span class="left_nav_pointer"></span> <span class="plus"><i class="fa fa-plus"></i></span> </a>
                            <ul class="opened" style="display:block">
                                ...
                                <li>
                                    <a href="Resultados.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">Resultados</b> </a>
                                </li>
                                <li>
                                          ...
                                          for($i=0; $i<$lista_usuario; $i++){
                                            ...
                                            if(!$link){
                                                echo 'No Se pudo establecer conexion: '.mysql_error();
                                                    ...
                                                    $sqlvotos = "SELECT COUNT(*) Nombre,sistema1.candidatos.Nombre, Partido, Cargo FROM sistema1.candidatos INNER JOIN db706267167.voto ON sistema1.candidatos.Nombre = sistema1.voto.Precidente WHERE Nombre = ".$lista_usuario['Numero_Interno']."';";
                                                    $ejecutar_sentenciavotos = $link->query($sql);
                                                    if(!$ejecutar_sentenciavotos)
                                                    {
                                                        echo 'Hay un error en la sentencia de SQL: '.$sql;
                                                    }else{
                                                        //paso 4 trer los datos en forma de un arreglo
                                                        $lista_votos =$ejecutar_sentenciavotos->fetch_array();
                                                        
                                                        for($j=0; $j<$lista_votos; $j++){
                                                            echo "<tr>";
                                                            echo "<td>";
                                                                echo $lista_votos['Nombre'];
                                                            echo "</td>";
                                                            ...
                                                            echo "<td>";
                                                            echo $lista_votos['Partido'];
                                                            echo "</td>";
          
                                                            echo "<td>";
                                                                echo $lista_votos['Cargo'];
                                                            echo "</td>";
