<?php
    ...
    if(!$link){
        echo 'No Se pudo establecer conexion: '.mysql_error();
            ...
            $sqlPresidente = "SELECT id, RFID,Nombre,Apellido,Cargo,Partido FROM db706267167.candidatos;";
    ...
    if(!$link){
        echo 'No Se pudo establecer conexion: '.mysql_error();
            ...
            //paso 3 hacer la sentencia sql y ejecutarla
            $sqlDiputado = "SELECT id, RFID,Nombre,Apellido,Cargo,Partido FROM db706267167.candidatos;";
    ...
    if(!$link){
        echo 'No Se pudo establecer conexion: '.mysql_error();
            ...
            //paso 3 hacer la sentencia sql y ejecutarla
            $sqlAlcalde = "SELECT id, RFID,Nombre,Apellido,Cargo,Partido FROM db706267167.candidatos;";
