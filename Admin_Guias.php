...
<body class="dark_theme  fixed_header left_nav_fixed light_theme green_thm">
            ...
            <div class="contentpanel">
                ...
                <!-- Iicia Contenido -->
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <button class="btn btn-outline-success my-2 my-sm-0" type="button" onclick="CargarNuevaGuia()">Nueva Guia</button>
                        <button class="btn btn-outline-info my-2 my-sm-0" type="button" onclick="CargardetallesGuia()">Visualizar Todas las Guias</button>
                        </form>
                    </div>
                    </nav>
                    <br>
                        ...
                        <table>
                                    <tr>
                                        ...
                                        for ($i = 0; $i < $lista_Guias; $i++) {
                                            ...
                                            echo "<td>";
                                                    echo '<a href="DetalleGia.php?Guia#'.$lista_Guias['ID_GUIA'].'"  class="fa fa-dashboard btn btn-primary data-togle="modal" data-target="#myModal"></a>';
                                            echo "</td>";
                                            
                                            echo "<td>";
                                                    echo '<a href="'.$lista_Guias['ID_GUIA'].'"  class="fa fa-search btn btn-info data-togle="modal" data-target="#myModal"></a>';
                                            echo "</td>";
    ...
    <script src="LogicaJs/NuevosObjetos.js"></script>
    ...
    function CargardetallesGuia(){
     location.href = "http://localhost/Projects/MoleTracker/Admin_GuiasTodas.php";
    }
    </script>
