    ...
    <div class="inner">
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <form class="form-inline my-2 my-lg-0">
                                    <div>
                                        <button class="fa fa-newspaper btn btn-success my-2 my-sm-0" type="button"
                                                style="margin-right: 10px;" onclick="CargarNuevaGuia()"> Programar Guia
                                        </button>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <button class="btn btn-secondary my-2 my-sm-0 fa fa-download" id="btnExportar">
                                            Exportar
                                        </button>
                                ...
                                <form role="form" action="" method="post" class="">
                                    <table id="example" class="table table-striped  " cellspacing="0" width="100%">
                                        ...
                                        for ($i = 0; $i < $lista_Guias; $i++) {
                                            ...
                                            echo "<td>";
                                            echo '<a href="DetalleGia.php?Guia=' . $lista_Guias['GuiaSAP'] . '"  class="fa fa-dashboard btn btn-primary data-togle="modal" data-target="#myModal"></a>';
                                            echo "</td>";
        ...
        <script>
            function CargarNuevaGuia() {
                location.href = "http://localhost:63342/MoleTracker/Admin_NuevoGuia.php";
            }
        </script>

        <script>
            function CargardetallesGuia() {
                location.href = "http://localhost:63342/MoleTracker/Admin_GuiasTodas.php";
            }
        </script>
