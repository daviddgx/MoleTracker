...
$MarcaViene =  $_GET["Marca"];
$ModeloViene =  $_GET["Modelo"];
$PlacaViene =  $_GET["Placa"];
$LineaViene =  $_GET["Linea"];
$UnidadViene =  $_GET["Unidad"];
$VelocidadViene =  $_GET["Velocidad"];
...
if (!empty($_POST['Programar'])) {
    ...
    $sql = "   update traker_mole.trck_mle_vehiculos set Marca = '".$Marca."', Modelo='".$Modelo."',Placa ='".$Placa."', Linea ='".$Linea."', Tipo ='".$Tipo."',Velocidad ='".$Velocidad."', Capacidad ='".$Capacidad."' where Id_Vehiculo= '$IdUnidad'";

    if ($conn->query($sql) === TRUE) {
        $mensajeExito = '<div class="alert alert-success" role="alert">Se modifico correctamente la unidad</div>';
    } else {
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12  myform-all" justify-content-center>
                                <h1><strong>Modificar</strong>  unidad</h1>
                            </div>
                            ...
                            <div class="col-sm-12   myform-cont justify-content-center">
                                <div class="myform-top">
                                    <div class="myform-top-left">
                                        ...
                                        <p>Ingrese la información de la  unidad:</p>
                                    </div>
