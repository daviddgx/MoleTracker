        ...
        try {
            ...
            while ($rowPiloto = $EsUsuarioPiloto->fetch_assoc()) {
                    ...
                    if($rowPiloto['Valor']){
                        ...
                        while ($rowGuaActiva = $GuiaActivada->fetch_assoc()) {

                            if(!$GuiaActivada->num_rows <= 0){
                    ...
                    <ul>
                        <li class="left_nav_active theme_border"><a href="javascript:void(0);"><i class="fa fa-home"></i> TRACKER <span class="left_nav_pointer"></span> <span class="plus"><i class="fa fa-plus"></i></span> </a>
                            <ul class="opened" style="display:block">
                                <li>
                                    <a href="DashboardSupervisorAreas.php"> <span>&nbsp;</span> <i class="fa fa-circle class="theme_color""></i> <b class="theme_color" >Registro pilotos</b> </a>
                                </li>
                                <li>
                                    <?php
                    ...
                    <div class="myform-all Color_Claro">
                        ...
                        <div class="my-content formulario">
                            <form role="form" action="" method="post">
                                ...
                                <div class="form-grup">
                                    <input type="text" name="RFIDLog" placeholder="RFID del piloto..." class="form-control" id="form-username">
                                </div>
                                <br>
