            ...
            <div class="contentpanel">
                ...
                <!-- Iicia Contenido -->
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <button class="btn btn-outline-danger my-2 my-sm-0" type="button" onclick="RegresarAreas()">Regresar</button>
...
{
     location.href = "http://localhost/Projects/MoleTracker/Admin_Areas.php";
} 
    </script> 
