...
if (!empty($_POST['Programar'])) {
    ...
    $sql = "insert into traker_mole.trck_mle_areas values (ID_AREA,'".$Nombre."','".$TipoArea."','".$EsFinal."','".$EsInicial."','".$AreaSiguente."','".$AreaAnterior."','".$Descripcion."','".$MinutosMinimos."','".$MinutosMaximos."')";
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12  myform-all" justify-content-center>
                                <h1><strong>Registro</strong> área nueva</h1>
                            </div>
                            ...
                            <div class="col-sm-12   myform-cont justify-content-center">
                                <div class="myform-top">
                                    <div class="myform-top-left">
                                        ...
                                        <p>Ingrese la información del área nueva:</p>
                                    </div>
