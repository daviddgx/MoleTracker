                ...
                <ul>
                    <li class="left_nav_active theme_border"><a href="javascript:void(0);"><i class="fa fa-home"></i>
                        ...
                        <ul class="opened" style="display:block">
                            ...
                            <li>
                                <a href="Admin_Pilotos.php"> <span>&nbsp;</span> <i class="fa fa-circle "></i> <b>Pilotos</b>
                                </a>
                            </li>
                            <li>
                                <a href="Admin_Usuarios.php"> <span>&nbsp;</span> <i
                                            class="fa fa-circle theme_color"></i> <b class="theme_color">Usuarios</b>
                                </a>
                            </li>
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <form class="form-inline my-2 my-lg-0">
                                    ...
                                    <button class="fa fa-user btn btn-success my-2 my-sm-0" type="button"
                                            onclick="CrearUsuario()"> Registrar Nuevo Usuario
                                    </button>
                            ...
                            <div class="myform-all Color_Claro">
                                ...
                                <form role="form" action="" method="post" class="">
                                    <table id="example" class="table table-striped  " cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                        <?php
                                        for ($i = 0; $i < $Lista_UsuariosApp; $i++) {
                                            echo "<tr>";
                                            echo "<td>";
                                            echo $Lista_UsuariosApp['RFID'];
                                            echo "</td>";

                                            echo "<td>";
                                            echo $Lista_UsuariosApp['Nombre'];
                                            echo "</td>";

                                            echo "<td>";
                                            echo $Lista_UsuariosApp['Apellido'];
                                            echo "</td>";
                                            ...
                                            echo "<td>";
                                            echo $Lista_UsuariosApp['Usuario'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $Lista_UsuariosApp['Estatus'];
                                            echo "</td>";
