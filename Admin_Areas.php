...
include 'Auth.php';
include 'LQS_EUQ/AreasRegistradas.php';
                ...
                <ul>
                    <li class="left_nav_active theme_border"><a href="javascript:void(0);"><i class="fa fa-home"></i>
                        ...
                        <ul class="opened" style="display:block">
                            ...
                            <li>
                                <a href="Admin_Areas.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i>
                                    <b class="theme_color">Areas</b> </a>
                            </li>
                            <li>
        ...
        <div class="contentpanel">
            ...
            <div class="pull-left breadcrumb_admin clear_both">
                <div class="pull-left page_title theme_color">
                    <h1>Configuración del proceso de Areas</h1>
                ...
                <div class="container clear_both padding_fix">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <form class="form-inline my-2 my-lg-0">
                                ...
                                <button class="fa fa-house-user btn btn-success my-2 my-sm-0" type="button"
                                        onclick="CrearAreaNueva()"> Registrar Area Nueva
                                </button>
                    ...
                    <div class="container" id="listausuarios">
                        <div class="myform-all Color_Claro">
                            ...
                            <br>
                            <h1 class="Titulos">Areas Registradas</h1>
                            <form role="form" action="" method="post" class="">
                                <table id="example" class="table table-striped  " cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                    <?php
                                    for ($i = 0; $i < $lista_Areas; $i++) {
                                        echo "<tr>";
                                        echo "<td>";
                                        echo $lista_Areas['ID_AREA'];
                                        echo "</td>";

                                        echo "<td>";
                                        echo $lista_Areas['NOMBRE'];
                                        echo "</td>";

                                        echo "<td>";
                                        echo $lista_Areas['ES_FINAL'];
                                        echo "</td>";

                                        echo "<td>";
                                        echo $lista_Areas['ES_INICIAL'];
                                        echo "</td>";

                                        echo "<td>";
                                        echo $lista_Areas['AREA_SIGUIENTE'];
                                        echo "</td>";
                                        echo "<td>";
